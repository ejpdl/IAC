  ...
  Future<void> _checkUserStatus() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('https://flutterapi-q64f.onrender.com/PC_List/view_all'),
      );
...
// In _ComputerPageState class:
  ...
  Future<void> _requestPC(String pcId) async {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse('https://flutterapi-q64f.onrender.com/api/request-pc'),
        headers: {
  ...
  void _showComputerDialog(
    ...
    if (status.toLowerCase() == 'occupied') {
      try {
        final response =
            await http.get(Uri.parse('https://flutterapi-q64f.onrender.com/api/pc-time/$pc'));
